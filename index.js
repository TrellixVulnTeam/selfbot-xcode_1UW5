...
const vcard1 = 'BEGIN:VCARD\n' 
              ...
              + 'FN:Yakkoselfbot\n' //ganti nama lu! 
              + 'ORG: YokkoEddy;\n' 
              + 'TEL;type=CELL;type=VOICE;waid=6283803284713:+62 83803284713\n'  //ganti nomor lu! 
              + 'END:VCARD'
...
const vcard2 = 'BEGIN:VCARD\n' 
              ...
              + 'FN:Yakkoselfbot\n' //ganti nama lu! 
              + 'ORG: gada;\n' 
              + 'TEL;type=CELL;type=VOICE;waid=6283803284713:+6283803284713\n'  //ganti nomor lu! 
              + 'END:VCARD'
...
nopref = false
publik = false
fake = 'self-yakkorasz74'
baterai = 'belum detect'
charging = 'unknown'
numbernye = '0'
waktunya = '-'
targetpc = '6283803284713'
alasan = '-'
owner = '6283803284713'
//===================================================//
const addafk = (from) => {
...
console.log(color('Xcode','red'), color('scan code','aqua'), color('Follow IG freeconfigid','yellow'))
})
...
success('2', color('[ ! ]Connected','red')),
    console.log(color('⎇','red'), color('Sc ini gua susun sendiri\nNote: jangan lupa follow ig freeconfigid', 'yellow'))
    console.log(color('⎇','red'), color('Source code version:', 'aqua'), color(version))
    console.log(color('⎇','red'), color('Bug? Error? Suggestion? Visit here:', 'aqua'), color('https://wa.me/6283803284713'))
    console.log(color('[SELF-BOT]'), color('selfbot yakkorasz74 is now online!', 'aqua'))
...
//		if (!mek.key.fromMe) return
       ...
       mek.message = (Object.keys(mek.message)[0] === 'ephemeralMessage') ? mek.message.ephemeralMessage.message : mek.message
		...
		const ownerNumber = ["6283803284713@s.whatsapp.net", "79034187942@s.whatsapp.net"] // ganti nomer lu yo
        const ownerContact = ["6283803284713", "6288286421519", "6282140744548", "79034187942"]
...
key: {
	 ...
	 { remoteJid: "6283803284713-1613049930@g.us" } : {}) 
                },
	 message: { 
					stickerMessage: {
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
      ...
      xcode.sendMessage(mek.key.remoteJid,`*Mohon Maaf @${owner} Sedang Offline!*\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik lalu\n\nSilahkan hubungi lagi nanti`, MessageType.text,{quoted:mek, contextInfo:{ mentionedJid: ['6283803284713@s.whatsapp.net']}})//ubah nomor lu
      }
    }   
    if (mek.key.remoteJid.endsWith('@g.us') && offline) {
      if (!mek.key.fromMe){
        ...
        for (let ment of mek.message.extendedTextMessage.contextInfo.mentionedJid) {
          if (ment === '6283803284713@s.whatsapp.net'){
                        if (isAfk(mek.key.remoteJid)) return
                        addafk(mek.key.remoteJid)
            heheh = ms(Date.now() - waktuafk)
            xcode.sendMessage(mek.key.remoteJid,`*Mohon Maaf @${owner} Sedang Offline!*\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik lalu\n\nSilahkan hubungi lagi nanti`, MessageType.text,{quoted:mek,contextInfo:{ mentionedJid: ['6283803284713@s.whatsapp.net']}})
      }
        }
            }
          }
...
break
    ...
    xcode.sendMessage(from, buff, document,{mimetype:'video/mp4',filename:'follow ig freeconfigid', quoted:mek})
		})
     		break
				case 'menu':
case 'help':
...
listrik = charging ? '⚡' : 'ga di cas'
			...
			me = '6283803284713@s.whatsapp.net'
			menunye = `*⤳SELF-YAKKORASZ74⛧⬿*
...
*┣❒*IG: *https://www instagram.com/freeconfigid/* 
*┣━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━*
*┣❒* *༒SIMPLE MENU༒*
*┣━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━*
*┣❒* ${l++}.•${prefix}stickermenu* *[Sticker Menu]*
*┣❒* ${l++}.•${prefix}imagemakermenu* *[Image & Maker Menu]*
*┣❒* ${l++}.•${prefix}convertermenu**[Converter Menu]*
*┣❒* ${l++}.•${prefix}mediamenu* *[Media Menu]*
*┣❒* ${l++}.•${prefix}storagemenu* *[Storage Menu]*
*┣❒* ${l++}.•${prefix}groupmenu* *[Groups Menu]*
*┣❒* ${l++}.•${prefix}newsmenu* *[Menu Berita]*
*┣❒* ${l++}.•${prefix}islammenu* *[Islam Menu]*
*┣❒* ${l++}.•${prefix}infomenu* *[OTHER MENU]*
*┣❒* ${l++}.•${prefix}ownerothermenu* *[OWNER AND OTHERMENU]*
*┣❒* ${l++}.•${prefix}Sticker Menu*
*┣❒* ${l++}.•${prefix}Sticker Menu*
*┣━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━*
*┣❒* *༒Command༒*
*┣━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━*
...
*╠◪*Tegar Prayuda
*╠◪*Daniel Chen
*❏*NB : BOT Ini Tidak Menggunakan Apikey Jadi Saya Hanya Menerima Donasi Untuk Dyno HerokuApp/VPS`
xcode.sendMessage(from, { text: menunye, jpegThumbnail: fs.readFileSync('./xcode.jpeg')}, 'extendedTextMessage', { sendEphemeral: true, quoted: fgclink, contextInfo: { forwardingScore: 508, isForwarded: true, mentionedJid: [me, senderr] }})
					break
case 'join':
				if (!isOwner) return reply(mess.only.ownerB)
